"""
Django settings for sdfdfsdf_1 project.
...
WSGI_APPLICATION = 'sdfdfsdf_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sdfdfsdf_1 API",
    "DESCRIPTION": "API documentation for sdfdfsdf_1 App",
    "VERSION": "v1",
}
